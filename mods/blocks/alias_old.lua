...
minetest.register_alias("variations:stone_small_brick", "variations:small_brick_stone")
register_shapes_alias("variations:stone_small_brick", "variations:small_brick_stone")
