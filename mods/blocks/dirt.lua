...
minetest.register_node("blocks:dirt_with_grass", {
	...
	tiles = {
		"blocks_grass.png",
		"blocks_dirt.png",
		{ name = "blocks_dirt.png^blocks_grass_side.png", tileable_vertical = false },
	},
...
minetest.register_node("blocks:dirt_with_grass_footsteps", {
	...
	tiles = {
		"blocks_grass.png^blocks_footprint.png",
		"blocks_dirt.png",
		{ name = "blocks_dirt.png^blocks_grass_side.png", tileable_vertical = false },
	},
...
minetest.register_node("blocks:dirt_with_dry_grass", {
	...
	tiles = {
		"blocks_dry_grass.png",
		"blocks_dirt.png",
		{ name = "blocks_dirt.png^blocks_dry_grass_side.png", tileable_vertical = false },
	},
	groups = { crumbly = 3, soil = 1, spreading_dirt_type = 1 },
	drop = "blocks:dirt",
	sounds = default.node_sound_dirt_defaults({
...
minetest.register_node("blocks:dirt_with_rainforest_litter", {
	...
	tiles = {
		...
		"blocks_dirt.png",
		{ name = "blocks_dirt.png^blocks_rainforest_litter_side.png", tileable_vertical = false },
	},
	groups = { crumbly = 3, soil = 1, spreading_dirt_type = 1 },
	drop = "blocks:dirt",
	sounds = default.node_sound_dirt_defaults({
...
minetest.register_node("blocks:dirt_with_coniferous_litter", {
	...
	tiles = {
		...
		"blocks_dirt.png",
		{ name = "blocks_dirt.png^blocks_coniferous_litter_side.png", tileable_vertical = false },
	},
	groups = { crumbly = 3, soil = 1, spreading_dirt_type = 1 },
	drop = "blocks:dirt",
	sounds = default.node_sound_dirt_defaults({
...
minetest.register_node("blocks:dry_dirt_with_dry_grass", {
	...
	tiles = {
		"blocks_dry_grass.png",
		"blocks_dry_dirt.png",
		{ name = "blocks_dry_dirt.png^blocks_dry_grass_side.png", tileable_vertical = false },
	},
	groups = { crumbly = 3, soil = 1 },
