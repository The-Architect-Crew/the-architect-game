...
local function furnace_node_timer(pos, elapsed)
	...
	if fuel_totaltime ~= 0 then
		...
		formspec = blocks.get_furnace_active_formspec(fuel_percent, item_percent)
		swap_node(pos, "blocks:furnace_active")
		...
		formspec = blocks.get_furnace_inactive_formspec()
		swap_node(pos, "blocks:furnace")
