...
minetest.register_node("blocks:river_water_source", {
	...
	tiles = {
		{
			name = "blocks_river_water_source_animated.png",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
...
minetest.register_node("blocks:lava_source", {
	...
	tiles = {
		{
			name = "blocks_lava_source_animated.png",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
	...
	drowning = 1,
	liquidtype = "source",
	liquid_alternative_flowing = "blocks:lava_flowing",
	liquid_alternative_source = "blocks:lava_source",
	liquid_viscosity = 7,
	liquid_renewable = false,
