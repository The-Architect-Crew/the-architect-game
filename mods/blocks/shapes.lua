...
shapes:register_shape("blocks:pine_wood", {groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},})
shapes:register_shape("blocks:acacia_wood", {groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},})
shapes:register_shape("blocks:aspen_wood", {groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},})
-- sand.lua
...
shapes:register_shape("blocks:stonebrick", {groups = {cracky = 2},})
shapes:register_shape("blocks:stone_block", {groups = {cracky = 2},})
...
shapes:register_shape("blocks:desert_stonebrick", {groups = {cracky = 2},})
shapes:register_shape("blocks:desert_stone_block", {groups = {cracky = 2},})
