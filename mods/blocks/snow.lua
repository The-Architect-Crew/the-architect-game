...
minetest.register_node("blocks:dirt_with_snow", {
	...
	tiles = {
		"blocks_snow.png",
		"blocks_dirt.png",
		{ name = "blocks_dirt.png^blocks_snow_side.png", tileable_vertical = false },
	},
...
minetest.register_node("blocks:permafrost_with_stones", {
	...
	tiles = {
		"blocks_permafrost.png^blocks_stones.png",
...
minetest.register_node("blocks:permafrost_with_moss", {
	...
	tiles = {
		"blocks_moss.png",
		"blocks_permafrost.png",
		{ name = "blocks_permafrost.png^blocks_moss_side.png", tileable_vertical = false },
	},
	groups = { cracky = 3 },
	sounds = default.node_sound_dirt_defaults({
