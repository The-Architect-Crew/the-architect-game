...
minetest.register_lbm({
	...
	action = function(pos, node)
		if node.param2 == 0 then
			minetest.set_node(pos, { name = "blocks:torch_ceiling", param2 = node.param2 })
		elseif node.param2 == 1 then
			minetest.set_node(pos, { name = "blocks:torch", param2 = node.param2 })
		else
			minetest.set_node(pos, { name = "blocks:torch_wall", param2 = node.param2 })
		end
	end,
})
