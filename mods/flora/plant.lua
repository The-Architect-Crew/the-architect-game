...
minetest.register_node("flora:cactus", {
	...
	tiles = { "flora_cactus_top.png", "flora_cactus_top.png", "flora_cactus_side.png" },
	paramtype2 = "facedir",
	groups = { choppy = 3 },
...
minetest.register_node("flora:large_cactus_seedling", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		itemstack = flora.sapling_on_place(
			itemstack,
			placer,
			pointed_thing,
...
function flora.grow_papyrus(pos, node)
	...
	if
		name ~= "blocks:dirt"
		and name ~= "blocks:dirt_with_grass"
		and name ~= "blocks:dirt_with_dry_grass"
		and name ~= "blocks:dirt_with_rainforest_litter"
		and name ~= "blocks:dry_dirt"
		and name ~= "blocks:dry_dirt_with_dry_grass"
	then
		return
	end
...
minetest.register_node("flora:grass_1", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		return ItemStack("flora:grass_1 " .. itemstack:get_count() - (1 - ret:get_count()))
	end,
})
...
minetest.register_node("flora:dry_grass_1", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local ret = minetest.item_place(stack, placer, pointed_thing)
		return ItemStack("flora:dry_grass_1 " .. itemstack:get_count() - (1 - ret:get_count()))
	end,
})
...
minetest.register_node("flora:fern_1", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local ret = minetest.item_place(stack, placer, pointed_thing)
		return ItemStack("flora:fern_1 " .. itemstack:get_count() - (1 - ret:get_count()))
	end,
})
...
minetest.register_node("flora:marram_grass_1", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local ret = minetest.item_place(stack, placer, pointed_thing)
		return ItemStack("flora:marram_grass_1 " .. itemstack:get_count() - (1 - ret:get_count()))
	end,
})
